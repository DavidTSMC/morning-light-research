...
OUT = Path(
    "reports/daily_report/daily_practical_report_v0_4.txt"
)

# ============================================================
# MORNING LIGHT DAILY PRACTICAL REPORT v0.4
...
def report():
    ...
    print()
    print("⚔️【Decision Module｜三劍客】")
    print("-" * 82)

    print("Technical       🟢 ↑   X0   Fresh Event")
    print("Cross-Market    🟡 ↑   X2   Direction Continues")
    print("Capital         🟡 →        Net Total +____")

    print()
    print("Evidence        2/3 Confirmed")
    print("Confidence      MEDIUM-HIGH")
    print("Amount          🌱 PROBE → + ADD")
    print("⚠ DISPLAY SAMPLE ONLY｜NOT A LIVE SIGNAL")
