...
OUT_TXT = Path(
    "reports/amount/individual_risk_budget_v0_5R2_failure_structure.txt"
)

OUT_CSV = Path(
    "reports/amount/individual_risk_budget_v0_5R2_failure_buckets.csv"
)
...
def report():
    ...
    print("=" * 122)
    print("INDIVIDUAL RISK BUDGET v0.5R2 — IDENTITY-CLEAN HISTORICAL FAILURE STRUCTURE")
    print("SOURCE: v0.5R UNIQUE ECONOMIC DECISIONS")
    ...
    print()
    print("=" * 122)
    print("INDIVIDUAL RISK BUDGET v0.5R2 COMPLETE")
    print(
